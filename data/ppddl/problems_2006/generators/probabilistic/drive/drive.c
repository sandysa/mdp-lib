...
void print_domain() 
{
  printf("(define (domain drive)\n");
  printf("        (:requirements :typing :probabilistic-effects :conditional-effects :disjunctive-preconditions :equality)\n");
  printf(" \n");
  ...
  printf("                             9/10\n");
  printf("                             (when (and (heading north) (light_preference ?x ?y north_south))\n");
  ...
  printf("                           (probabilistic\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading south) (light_preference ?x ?y north_south))\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             1/10 \n");
  printf("                             (when (and (heading south) (light_preference ?x ?y north_south))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  printf("                           (probabilistic\n");
  printf("                             1/10\n");
  printf("                             (when (and (heading east) (light_preference ?x ?y north_south))\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading east) (light_preference ?x ?y north_south))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  ...
  printf("                           (probabilistic\n");
  printf("                             1/10\n");
  printf("                             (when (and (heading west) (light_preference ?x ?y north_south))\n");
  printf("                                    (and (not (light_color unknown))(light_color green)))\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading west) (light_preference ?x ?y north_south))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  ...
  printf("                           (probabilistic\n");
  printf("                             1/10\n");
  printf("                             (when (and (heading north) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading north) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  printf("                           (probabilistic\n");
  printf("                             1/10\n");
  printf("                            (when (and (heading south) (light_preference ?x ?y east_west))\n");
  printf("                                  (and (not (light_color unknown))(light_color green)))\n");
  printf("                             9/10\n");
  printf("                            (when (and (heading south) (light_preference ?x ?y east_west))\n");
  printf("                                  (and (not (light_color unknown))(light_color red))))\n");
  printf("                           (probabilistic\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading east) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             1/10\n");
  printf("                             (when (and (heading east) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  ...
  printf("                           (probabilistic\n");
  printf("                             9/10\n");
  printf("                             (when (and (heading west) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             1/10\n");
  printf("                             (when (and (heading west) (light_preference ?x ?y east_west))\n");
  printf("                                   (and (not (light_color unknown))(light_color red))))\n");
  printf("                            (probabilistic\n");
  printf("                             1/2\n");
  printf("                             (when (light_preference ?x ?y none)\n");
  printf("                                   (and (not (light_color unknown))(light_color green)))\n");
  printf("                             1/2\n");
  printf("                             (when (light_preference ?x ?y none)\n");
  printf("                                   (and (not (light_color unknown))(light_color red)))))\n");
  ...
  printf("                :parameters (?x - coord ?y - coord)\n");
  printf("                :precondition (and\n");
  printf("                                (light_color red)\n");
  printf("                                (at ?x ?y)\n");
  printf("                        )\n");
  printf("                :effect (and\n");
  printf("                            (probabilistic\n");
  printf("                                1/100 (not (alive))\n");
  printf("                            )\n");
  printf("                            (probabilistic\n");
  printf("                              1/2\n");
  printf("                              (when (light_delay ?x ?y quick)\n");
  printf("                                    (and (not (light_color red))(light_color green))))\n");
  printf("\n");
  printf("                            (probabilistic\n");
  printf("                              1/5\n");
  printf("                              (when (light_delay ?x ?y normal)\n");
  printf("                                    (and (not (light_color red))(light_color green))))\n");
  printf("\n");
  printf("                            (probabilistic\n");
  printf("                              1/10\n");
  printf("                              (when (light_delay ?x ?y slow)\n");
  printf("                                    (and (not (light_color red))(light_color green))))\n");
  printf("                        )\n");
  printf("        )\n");
  printf("\n");
  printf("        (:action proceed\n");
  printf("                :parameters (?x ?y ?new-x ?new-y - coord\n");
  printf("                             ?old-heading ?new-heading - direction\n");
  printf("                             ?length - length ?turn-direction - rotation)\n");
  printf("                :precondition (and\n");
  printf("                                (light_color green)\n");
  printf("                                (at ?x ?y)\n");
  printf("                                (heading ?old-heading)\n");
  printf("                                (or (and (= ?turn-direction right)\n");
  printf("                                         (clockwise ?old-heading ?new-heading))\n");
  printf("                                    (and (= ?turn-direction left)\n");
  printf("                                         (clockwise ?new-heading ?old-heading))\n");
  printf("                                    (and (= ?turn-direction straight)\n");
  printf("                                         (= ?new-heading ?old-heading)))\n");
  printf("                                (nextx ?x ?new-x ?new-heading)\n");
  printf("                                (nexty ?y ?new-y ?new-heading)\n");  
  printf("                                (road-length ?x ?y ?new-x ?new-y ?length))\n");
  printf("                :effect (and\n");
  printf("                                (not (light_color green))\n");
  printf("                                (light_color unknown)\n");
  printf("                                (probabilistic\n");
  printf("                                  1/50 \n");
  printf("                                  (when (= ?length short)\n");
  printf("                                        (not (alive))))\n");
  printf("                                (probabilistic\n");
  printf("                                  1/20 \n");
  printf("                                  (when (= ?length medium)\n");
  printf("                                        (not (alive))))\n");
  printf("                                (probabilistic\n");
  printf("                                  1/10 \n");
  printf("                                  (when (= ?length long)\n");
  printf("                                        (not (alive))))\n");
  printf("                                (not (at ?x ?y))\n");
...
void print_problem() 
{
  ...
  printf("(define (problem a-drive-problem%d)\n", rand()%1000);
  printf("(:domain drive)\n");
  printf("(:objects ");
