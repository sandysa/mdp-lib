...
(:action pitch
 ...
 :effect  (and (thrown)
               (not (not-thrown))
               (probabilistic 44/100 (ball-in-the-air-of-type T0))
               (probabilistic 24/100 (ball-in-the-air-of-type T1))
               (probabilistic 54/100 (ball-in-the-air-of-type T2))
               (forall (?B - bit)
                       (probabilistic
...
(define (problem a-pitchcatch-problem738) 
(:domain pitchcatch)  
(:init (alive) 
       (not-thrown)
       (bit-on B0)
