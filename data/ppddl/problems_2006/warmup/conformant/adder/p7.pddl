(define (problem p7)
  (:domain adder)
  (:objects t f tmp1 tmp2 x1 y1 r1 z1 x2 y2 r2 z2 x3 y3 r3 z3 x4 y4 r4 z4 x5 y5 r5 z5 x6 y6 r6 z6 x7 y7 r7 z7 r8 z8 - bit)
  (:init (and (high t) (low f)
              (low r1) (low r2) (low r3) (low r4) (low r5) (low r6) (low r7) (low r8) 
              (low z1) (low z2) (low z3) (low z4) (low z5) (low z6) (low z7) (low z8) 
              ...
              (constant x1) (constant x2) (constant x3) (constant x4) (constant x5) (constant x6) (constant x7) 
              (constant y1) (constant y2) (constant y3) (constant y4) (constant y5) (constant y6) (constant y7) 
        )
  )
  (:goal (and (low r1)
              (or (low z8) (high r8))
