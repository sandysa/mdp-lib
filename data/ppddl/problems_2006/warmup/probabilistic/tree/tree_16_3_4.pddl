(define (domain tree_16_3_4)
  (:requirements :typing :probabilistic-effects :conditional-effects)
  (:types level db)
  (:constants L0 L1 L2 L3 L4 L5 L6 L7 L8 L9 L10 L11 L12 L13 L14 L15 L16 - level db0 db1 db2 db3 db4 db5 db6 db7 db8 db9 db10 db11 db12 db13 db14 db15 db16 - db)
