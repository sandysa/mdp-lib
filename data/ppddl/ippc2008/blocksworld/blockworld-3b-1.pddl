...
(:action pick-up-from-table
    :parameters (?b - block)
    :precondition (and (emptyhand) (clear ?b) (on-table ?b) (on-table b3))
    :effect
...
(define (problem p01)
  ...
  (:init (emptyhand) (on-table b1) (on-table b2) (on-table b3) (clear b2) (clear b3) (clear b1))
  (:goal (and (emptyhand) (on b2 b1) (on b3 b2) (on-table b1) (clear b3)))
  (:goal-reward 1)
