...
(:action pick-up-from-table
    :parameters (?b - block)
    :precondition (and (emptyhand) (clear ?b) (on-table ?b) (on-table b2))
    :effect
  ...
  (:action pick-up-from-table-not2
    :parameters (?b - block)
    :precondition (and (emptyhand) (clear ?b) (on-table ?b) (not(on-table b2)) )
    :effect
      (probabilistic 1/2 (and (holding ?b) (not (emptyhand)) (not (on-table ?b))))
  )
  ...
  (:action pick-tower-notbase2
    :parameters (?b1 ?b2 ?b3 - block)
    :precondition (and (emptyhand) (clear ?b1) (on ?b1 ?b2) (on ?b2 ?b3) (not(on-table b2)))
    :effect
      (probabilistic 1/10 (and (holding ?b2) (clear ?b3) (not (emptyhand)) (not (on ?b2 ?b3))))
  )
(:action pick-tower-withbase2
    :parameters (?b1 ?b2 ?b3 - block)
    :precondition (and (emptyhand) (clear ?b1) (on ?b1 ?b2) (on ?b2 ?b3) (on-table b2))
    :effect
      (probabilistic 1/10 (and (holding ?b2) (clear ?b3) (not (emptyhand)) (not (on ?b2 ?b3))))
  )
...
(define (problem p01)
  ...
  (:init (emptyhand) (on-table b1) (on-table b2) (on-table b3) (on b4 b1) (clear b2) (clear b3) (clear b4))
  (:goal (and (emptyhand) (on b1 b2) (on b2 b3) (on-table b4) (on b3 b4) (clear b1)))
  (:goal-reward 1)
